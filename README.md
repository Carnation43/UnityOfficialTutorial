...
<p style="font-weight: normal; margin: 0;">Display:</p>
<div style="display: flex; justify-content: center; align-items: center">
<img src="media/Prototype_1.gif" alt="示例图01">
</div>

<p style="font-weight: normal; margin: 0;">Knowledge point:</p>
...
<p style="font-weight: normal; margin: 0;">Notes:</p>
...
<p style="font-weight: normal; margin: 0;"> Implemented features(2025/09/05):</p>

- **Rotate the camera** 
- **Player movement, sprinting, jumping and crouching**

<p style="font-weight: normal; margin: 0;"> Core codes:</p>

<p style="font-weight: normal; margin: 0; font-size: 14px;"> file structure:</p>
...
<p style="font-weight: normal; margin: 0;"> Implemented features(2025/09/07):</p>
